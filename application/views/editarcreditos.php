<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
		...
		<div class="container">
			...
			<br>
			<br>
			<form action="<?php echo base_url();?>lancamentos/salvar_editar_creditos" method="POST">
				<div class="form-group row">
					<input type="hidden" name="idcreditos" value="{idcreditos}">
					<div class="col-xs-2">
	    ...
	    <div class="text-center">
	    	<h2>Este Crédito não existe para edição.</h2>
	    </div>
	    {/BLOCO_SEMDADOS}